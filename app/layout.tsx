...
export const t = {
  ...
  hero: {
    eyebrow: { nl: 'Tailor & Dry Cleaning · Amsterdam', en: 'Tailor & Dry Cleaning · Amsterdam' },
  ...
  highlights: {
    eyebrow: { nl: 'Wat 643 klanten zeggen', en: 'What 643 customers say' },
    items: [
      {
        stat: '★ 4,9',
        title: { nl: 'Uw jas is hier in goede handen', en: 'Your coat is in good hands here' },
        desc: { nl: 'Tientallen klanten schrijven dat hun dure winterjas — van Canada Goose tot Woolrich — perfect is hersteld. Niet van origineel te onderscheiden.', en: 'Dozens of customers write that their expensive winter coat — from Canada Goose to Woolrich — was restored perfectly. Indistinguishable from original.' },
      },
      {
        stat: '10+',
        title: { nl: 'Jaar vaste klanten', en: 'Years of loyal customers' },
        desc: { nl: 'Klanten komen hier al jaren. Eenmaal binnen, nooit meer weg. De eigenaren denken mee, helpen snel en behandelen elk kledingstuk met zorg.', en: 'Customers have been coming here for years. Once inside, never leave. The owners think along, help quickly and treat every garment with care.' },
      },
      {
        stat: '=',
        title: { nl: 'De originele zoom? Die houden we', en: 'The original hem? We keep it' },
        desc: { nl: 'Spijkerbroeken en pantalons worden ingekort met behoud van de originele zoom. Zodat niemand ziet dat er iets is veranderd.', en: 'Jeans and trousers are shortened while keeping the original hem. So nobody can tell anything was changed.' },
      },
      {
        stat: '⚡',
        title: { nl: 'Spoedklus? Geen probleem', en: 'Rush job? No problem' },
        desc: { nl: 'Knoop van uw smoking vlak voor een evenement? Gescheurde broek vlak voor een sollicitatie? Staring denkt mee en is er vaak diezelfde dag nog.', en: "Button off your tuxedo before an event? Torn trousers before a job interview? Staring thinks along and it's often done that same day." },
      },
    ],
  },
  reviews: {
    eyebrow: { nl: 'Klanten aan het woord', en: 'Customers speak' },
  ...
  prices: {
    eyebrow: { nl: 'Tarieven', en: 'Pricing' },
    title1: { nl: 'Eerlijke prijzen,', en: 'Fair prices,' },
  ...
  strip: {
    ...
    label2: { nl: 'Vers van de stomerij', en: 'Fresh from the cleaner' },
    label3: { nl: 'Staringplein 20HS', en: 'Staringplein 20HS' },
  },
  contact: {
    eyebrow: { nl: 'Bezoek ons', en: 'Visit us' },
    title1: { nl: 'Twee locaties', en: 'Two locations' },
    title2: { nl: 'in Amsterdam', en: 'in Amsterdam' },
    tagline: { nl: 'Gewoon binnenlopen — we zijn er voor u.', en: "Just walk in — we're here for you." },
    locations: [
      {
        name: 'Staringplein',
  ...
  footer: {
    copy: { nl: '© 2025 Staring Tailor & Dry Cleaning · Amsterdam', en: '© 2025 Staring Tailor & Dry Cleaning · Amsterdam' },
  },
} as const